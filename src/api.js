...
export async function getTowerByFlat(flat_id) {
  const res = await fetch(`${GATEWAY_BASE}/adm/tower`);
...
export async function getTowerById(tower_id) {
  const res = await fetch(`${GATEWAY_BASE}/adm/tower/${tower_id}`);
  return res.json();
}
...
export async function deleteTower(tower_id) {
  const res = await fetch(`${GATEWAY_BASE}/adm/tower/${tower_id}`, { method: 'DELETE' });
...
const API_BASE = `${GATEWAY_BASE}/adm/flat`;
...
export async function getAllFloors() {
  const res = await fetch(`${GATEWAY_BASE}/adm/floor`);
...
export async function getFloorDetail(floor_id) {
  const res = await fetch(`${GATEWAY_BASE}/adm/floor/${floor_id}`);
...
export async function deleteFloor(floor_id) {
  const res = await fetch(`${GATEWAY_BASE}/adm/floor/${floor_id}`, { method: 'DELETE' });
...
export async function getAllUnits() {
  const res = await fetch(`${GATEWAY_BASE}/adm/unit`);
  return res.json();
}
...
export async function getUnitDetail(unit_id) {
  const res = await fetch(`${GATEWAY_BASE}/adm/unit/${unit_id}`);
  const json = await res.json();
  return json.data;
}

export async function deleteUnit(unit_id) {
  const res = await fetch(`${GATEWAY_BASE}/adm/unit/${unit_id}`, { method: 'DELETE' });
...
export async function getPemilikByUnit(unit_id) {
  ...
  const resPemilik = await fetch(`${GATEWAY_BASE}/adm/pemilik/${unit.pemilik_id}`);
...
export async function getDevicesByUnit(unit_id) {
  const res = await fetch(`${GATEWAY_BASE}/adm/unit/${unit_id}/devices`);
...
export async function deletePemilik(pemilik_id) {
  const res = await fetch(`${GATEWAY_BASE}/adm/pemilik/${pemilik_id}`, { method: 'DELETE' });
...
export async function getSensorsByUnit(unit_id) {
  ...
  const res = await fetch(`${GATEWAY_BASE}/adm/sensor/unit/${unit_id}`);
...
export async function getAllSensors() {
  const res = await fetch(`${GATEWAY_BASE}/adm/sensor`);
...
export async function getSensorDetail(component_id) {
  const res = await fetch(`${GATEWAY_BASE}/adm/sensor/detail/${component_id}`);
